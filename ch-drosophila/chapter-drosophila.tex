...
%%
%Such a curve can be discovered using diffusion maps \citep{coifman2005geometric}, a nonlinear dimensionality reduction technique that reveals a parameterization of data that lies on a low-dimensional manifold in high-dimensional space.
%%
...
%%
%Instead, we will use diffusion maps which automatically uncovers a parameterization of our high-dimensional data from the eigenvectors of the appropriate matrix (see \sec~\ref{sec:dmaps}).
%%
