...
\end{aligned}
\end{equation}
where $W_i(t)$ are independent standard Brownian motions, $\mathbf{x}(t)  = \begin{bmatrix} x_1(t) & \cdots & x_\lowdim(t) \end{bmatrix}^T \in \mathbb{R}^\lowdim$, and $\epsilon \ll 1$.
%
...
Figures~\ref{fig:colored_data_nonlinear_cases}(a) and (b) show the data from Figure~\ref{fig:initial_data_nonlinear}, colored by $\phi_1$ for two different values of $\dmeps$.
%
