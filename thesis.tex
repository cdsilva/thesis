...
\title{Data Mining for Chemical and Biological Applications}

\submitted{June 2015}  % degree conferral date (January, April, June, September, or November)
...
\include{ch-math/chapter-math}
\include{ch-multiscale/chapter-multiscale}
\include{ch-merging/chapter-merging}
\include{ch-harmonics/chapter-harmonics}
%\include{ch-glass/chapter-glass}
%\include{ch-trpcage/chapter-trpcage}
\include{ch-drosophila/chapter-drosophila}
\include{ch-conclusion/chapter-conclusion}
\appendix % all chapters following will be labeled as appendices
\include{ch-multiscale/appendix-multiscale}
\include{ch-merging/appendix-merging}
%\include{ch-drosophila/appendix-drosophila}
